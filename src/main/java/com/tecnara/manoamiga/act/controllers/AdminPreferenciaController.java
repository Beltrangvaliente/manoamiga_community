...
@Controller
@RequestMapping("act/admin/preferencia")
public class AdminPreferenciaController extends TecnaraBaseController {
    ...
    public String list(Model m) {
        return "act/admin/preferencias_list";
    }
    ...
    public String form(Model m, Long id) {
        ...
        return "act/admin/preferencias_form";
    }
    ...
    public String testEmail(String email) {
        ...
        info.setFicheroEmail("act/test_email");
        info.setEmail(email);
