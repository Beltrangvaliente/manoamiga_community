...
@Controller
@RequestMapping("/emp/tecnico/usuario")
public class TecnicoUsuarioController extends TecnaraBaseController {
    ...
    public String form(Model m, Long id, String rol) {
        ...
        return "emp/tecnico/usuario_form";
    }

    @GetMapping("/list")
    public String list(Model m) {
        return "emp/admin/usuario_list";
    }

    @GetMapping("/help")
    public String help(Model m) {
        return "emp/tecnico/usuario_help";
    }
    ...
    public String guardar(UsuarioEntity registro, String enviarEmail) {
        ...
        if ("si".equalsIgnoreCase(enviarEmail)){
            ...
            info.setFicheroEmail("emp/usuario_guardar_password_email");
    ...
    public String buscador(Long id) {
        UsuarioEntity u=repoUsuario.findById(id).get();
        return u.getUsuario();
    }
    ...
    public String activarUsuario(Long idUsuario) {
        ...
        info.setFicheroEmail("/emp/usuario_activado");
    ...
    public String reestablecerPasswordEnviarEmail(Model m, Long id) {
        ...
        // findByEmail.get()
        //Enviar el email.
        return "emp/tecnico/usuario_recuperar_password_confirmacion";
    ...
    public String reestablecerPasswordEnviarEmailString(Model m, String email) {
        ...
        info.setCodigoUsuario(usu.getCodigoVerificacion());
        info.setTituloEmail("Reestablecer contraseña");
        info.setFicheroEmail("emp/usuario_reestablecer_password_enviar_email");
        info.setEmail(usu.getEmail());
        this.email.enviarEmail(info);
        // findByEmail.get()
        //Enviar el email.
        return "emp/tecnico/usuario_reestablecer_password_confirmacion";
