...
@Controller
@RequestMapping("/expo/trabajador/imagen")
public class TrabajadorImagenController extends TecnaraBaseController {

    @Autowired
    private IImagenRepository repoImagen;

    @GetMapping(value = "/descargar", produces = MediaType.IMAGE_JPEG_VALUE)
    public @ResponseBody
