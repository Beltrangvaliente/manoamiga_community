...
@Controller
@RequestMapping("/expo/coordinador/plantilla")
public class CoordinadorPlantillaController extends TecnaraBaseController {
    ...
    public String list(Model m) {
        return "expo/coordinador/plantilla_list";
    }
    ...
    public String form(Model m, Long id) {
        ...
        return "expo/coordinador/plantilla_form";
